...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1959896556;
...
abstract class RustLibApi extends BaseApi {
  ...
  String crateApiDocumentMicaDocumentExportMarkdownTitled({
    required MicaDocument that,
    required String title,
  });
  ...
  MicaDocument crateApiDocumentMicaDocumentFromMarkdownWithAssets({
    required String markdown,
  ...
  bool crateApiDocumentMicaDocumentSetTitle({
    required MicaDocument that,
    required String title,
  });
  ...
  Future<int> crateApiStoreMicaStoreBackfillSearchIndex({
    required MicaStore that,
    required int limit,
  });

  Future<List<LocalBacklink>> crateApiStoreMicaStoreBacklinksLocal({
    required MicaStore that,
  ...
  bool crateApiStoreMicaStoreCompactLocal({
    required MicaStore that,
    required String docId,
  });
  ...
  Future<LocalGraph> crateApiStoreMicaStoreGraphLocal({
    required MicaStore that,
  });
  ...
  Future<List<LocalSearchHit>> crateApiStoreMicaStoreSearchLocal({
    required MicaStore that,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  String crateApiDocumentMicaDocumentExportMarkdownTitled({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiDocumentMicaDocumentExportMarkdownTitledConstMeta,
  ...
  TaskConstMeta
  get kCrateApiDocumentMicaDocumentExportMarkdownTitledConstMeta =>
      const TaskConstMeta(
        debugName: "MicaDocument_export_markdown_titled",
        argNames: ["that", "title"],
      );
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          ...
          sse_encode_Map_String_String_None(assetIds, serializer);
        ...
        constMeta: kCrateApiDocumentMicaDocumentFromMarkdownWithAssetsConstMeta,
        argValues: [markdown, fromPath, assetIds],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta
  get kCrateApiDocumentMicaDocumentFromMarkdownWithAssetsConstMeta =>
      const TaskConstMeta(
        debugName: "MicaDocument_from_markdown_with_assets",
        argNames: ["markdown", "fromPath", "assetIds"],
      );
  ...
  bool crateApiDocumentMicaDocumentSetTitle({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiDocumentMicaDocumentSetTitleConstMeta,
        argValues: [that, title],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiDocumentMicaDocumentSetTitleConstMeta =>
      const TaskConstMeta(
        debugName: "MicaDocument_set_title",
        argNames: ["that", "title"],
      );
  ...
  Future<int> crateApiStoreMicaStoreBackfillSearchIndex({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiStoreMicaStoreBackfillSearchIndexConstMeta,
  ...
  TaskConstMeta get kCrateApiStoreMicaStoreBackfillSearchIndexConstMeta =>
      const TaskConstMeta(
        debugName: "MicaStore_backfill_search_index",
        argNames: ["that", "limit"],
      );
  ...
  Future<List<LocalBacklink>> crateApiStoreMicaStoreBacklinksLocal({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_local_backlink,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiStoreMicaStoreBacklinksLocalConstMeta,
  ...
  TaskConstMeta get kCrateApiStoreMicaStoreBacklinksLocalConstMeta =>
      const TaskConstMeta(
        debugName: "MicaStore_backlinks_local",
  ...
  bool crateApiStoreMicaStoreCompactLocal({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiStoreMicaStoreCompactLocalConstMeta,
        argValues: [that, docId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiStoreMicaStoreCompactLocalConstMeta =>
      const TaskConstMeta(
        debugName: "MicaStore_compact_local",
        argNames: ["that", "docId"],
      );
  ...
  Future<LocalGraph> crateApiStoreMicaStoreGraphLocal({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiStoreMicaStoreGraphLocalConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiStoreMicaStoreGraphLocalConstMeta =>
      const TaskConstMeta(
        debugName: "MicaStore_graph_local",
        argNames: ["that"],
      );
  ...
  Future<List<LocalSearchHit>> crateApiStoreMicaStoreSearchLocal({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_local_search_hit,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiStoreMicaStoreSearchLocalConstMeta,
  ...
  TaskConstMeta get kCrateApiStoreMicaStoreSearchLocalConstMeta =>
      const TaskConstMeta(
        debugName: "MicaStore_search_local",
  ...
  List<LocalBacklink> dco_decode_list_local_backlink(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_local_backlink).toList();
  }

  @protected
  List<LocalGraphEdge> dco_decode_list_local_graph_edge(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_local_graph_edge).toList();
  }

  @protected
  List<LocalGraphNode> dco_decode_list_local_graph_node(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_local_graph_node).toList();
  }

  @protected
  List<LocalSearchHit> dco_decode_list_local_search_hit(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_local_search_hit).toList();
  }
  ...
  LocalGraph dco_decode_local_graph(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return LocalGraph(
      nodes: dco_decode_list_local_graph_node(arr[0]),
      edges: dco_decode_list_local_graph_edge(arr[1]),
      unlinked: dco_decode_i_64(arr[2]),
    );
  }
  ...
  LocalSearchHit dco_decode_local_search_hit(dynamic raw) {
    ...
    return LocalSearchHit(
      ...
      objectId: dco_decode_String(arr[1]),
      name: dco_decode_String(arr[2]),
      parentViewId: dco_decode_opt_String(arr[3]),
      isFolder: dco_decode_bool(arr[4]),
      titleMatch: dco_decode_bool(arr[5]),
  ...
  List<LocalBacklink> sse_decode_list_local_backlink(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <LocalBacklink>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_local_backlink(deserializer));
    }
    return ans_;
  }
  ...
  List<LocalGraphEdge> sse_decode_list_local_graph_edge(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <LocalGraphEdge>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_local_graph_edge(deserializer));
    }
    return ans_;
  }
  ...
  List<LocalGraphNode> sse_decode_list_local_graph_node(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <LocalGraphNode>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_local_graph_node(deserializer));
    }
    return ans_;
  }
  ...
  List<LocalSearchHit> sse_decode_list_local_search_hit(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <LocalSearchHit>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_local_search_hit(deserializer));
    }
    return ans_;
  }
  ...
  LocalGraph sse_decode_local_graph(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_nodes = sse_decode_list_local_graph_node(deserializer);
    var var_edges = sse_decode_list_local_graph_edge(deserializer);
    var var_unlinked = sse_decode_i_64(deserializer);
    return LocalGraph(
      nodes: var_nodes,
      edges: var_edges,
  ...
  LocalGraphEdge sse_decode_local_graph_edge(SseDeserializer deserializer) {
    ...
    return LocalGraphEdge(source: var_source, target: var_target);
  }
  ...
  LocalGraphNode sse_decode_local_graph_node(SseDeserializer deserializer) {
    ...
    var var_viewId = sse_decode_String(deserializer);
    var var_name = sse_decode_String(deserializer);
    var var_degree = sse_decode_i_64(deserializer);
    return LocalGraphNode(
      viewId: var_viewId,
      name: var_name,
      degree: var_degree,
  ...
  LocalSearchHit sse_decode_local_search_hit(SseDeserializer deserializer) {
    ...
    var var_objectId = sse_decode_String(deserializer);
    var var_name = sse_decode_String(deserializer);
    var var_parentViewId = sse_decode_opt_String(deserializer);
    var var_isFolder = sse_decode_bool(deserializer);
    var var_titleMatch = sse_decode_bool(deserializer);
    var var_snippet = sse_decode_String(deserializer);
    return LocalSearchHit(
      viewId: var_viewId,
      objectId: var_objectId,
      name: var_name,
      parentViewId: var_parentViewId,
      isFolder: var_isFolder,
      titleMatch: var_titleMatch,
      snippet: var_snippet,
    );
  }
  ...
  void sse_encode_list_local_backlink(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_local_backlink(item, serializer);
    }
  }
  ...
  void sse_encode_list_local_graph_edge(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_local_graph_edge(item, serializer);
    }
  }
  ...
  void sse_encode_list_local_graph_node(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_local_graph_node(item, serializer);
    }
  }
  ...
  void sse_encode_list_local_search_hit(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_local_search_hit(item, serializer);
    }
  }
  ...
  void sse_encode_local_graph(LocalGraph self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_local_graph_node(self.nodes, serializer);
    sse_encode_list_local_graph_edge(self.edges, serializer);
    sse_encode_i_64(self.unlinked, serializer);
  }
  ...
  void sse_encode_local_graph_node(
    ...
    sse_encode_String(self.viewId, serializer);
    sse_encode_String(self.name, serializer);
    sse_encode_i_64(self.degree, serializer);
  }
  ...
  void sse_encode_local_search_hit(
    ...
    sse_encode_String(self.objectId, serializer);
    sse_encode_String(self.name, serializer);
    sse_encode_opt_String(self.parentViewId, serializer);
    sse_encode_bool(self.isFolder, serializer);
    sse_encode_bool(self.titleMatch, serializer);
...
class MicaDocumentImpl extends RustOpaque implements MicaDocument {
  ...
  String exportMarkdownTitled({required String title}) =>
      RustLib.instance.api.crateApiDocumentMicaDocumentExportMarkdownTitled(
        that: this,
        title: title,
      );
  ...
  /// same name.
  bool setTitle({required String title}) => RustLib.instance.api
      .crateApiDocumentMicaDocumentSetTitle(that: this, title: title);
...
class MicaStoreImpl extends RustOpaque implements MicaStore {
  ...
  Future<int> backfillSearchIndex({required int limit}) => RustLib.instance.api
      .crateApiStoreMicaStoreBackfillSearchIndex(that: this, limit: limit);
  ...
  Future<List<LocalBacklink>> backlinksLocal({required String viewId}) =>
      RustLib.instance.api.crateApiStoreMicaStoreBacklinksLocal(
        that: this,
        viewId: viewId,
      );
  ...
  bool compactLocal({required String docId}) => RustLib.instance.api
      .crateApiStoreMicaStoreCompactLocal(that: this, docId: docId);
  ...
  Future<LocalGraph> graphLocal() =>
      RustLib.instance.api.crateApiStoreMicaStoreGraphLocal(that: this);
  ...
  Future<List<LocalSearchHit>> searchLocal({
    required String query,
    required int limit,
  }) => RustLib.instance.api.crateApiStoreMicaStoreSearchLocal(
    that: this,
    query: query,
    limit: limit,
  );
